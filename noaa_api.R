library(RJSONIO, quietly = T, warn.conflicts = F)
library(RCurl, quietly = T, warn.conflicts = F)
library(jsonlite, quietly = T, warn.conflicts = F)
library(ggspatial, quietly = T, warn.conflicts = F)
library(geojsonio, quietly = T, warn.conflicts = F)
library(broom, quietly = T, warn.conflicts = F)
library(lubridate, quietly = T, warn.conflicts = F)
library(TSstudio, quietly = T, warn.conflicts = F)
library(ggplot2, quietly = T, warn.conflicts = F)
# s(library(doParallel, quietly = T, warn.conflicts = F)))
...
library(dygraphs, quietly = T, warn.conflicts = F)
